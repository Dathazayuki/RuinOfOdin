...
export const CARDS: Record<CardId, CardDefinition> = {
  ...
  rider: { id: 'rider', name: 'Rider', type: 'UNIT', cost: 3, attack: 3, hp: 4, description: 'Cavalry Charge: Battlecry grants +1 ATK to all your other units on the board.', art: 'UnitArt/Rider.png' },
  ...
  heal: { id: 'heal', name: 'Heal', type: 'SPELL', cost: 2, attack: 0, hp: 0, description: 'Restore 4 health to a friendly unit, up to its maximum.', art: 'SpellIcon/Heal.png', spellTarget: 'FRIENDLY_UNIT' },
  ...
  debuffcleanse: { id: 'debuffcleanse', name: 'Debuff Cleanse', type: 'SPELL', cost: 1, attack: 0, hp: 0, description: 'Cleanse Freeze and Poison from a friendly unit.', art: 'SpellIcon/DebuffCleanse.png', spellTarget: 'FRIENDLY_UNIT' },
  ...
  figure: { id: 'figure', name: 'Figure', type: 'SPELL', cost: 1, attack: 0, hp: 0, description: 'Create a spectral decoy copy of a friendly unit on an adjacent lane (decoy cannot attack).', art: 'SpellIcon/Figure.png', spellTarget: 'FRIENDLY_UNIT' },
