...
export const CARDS: Record<CardId, CardDefinition> = {
  ...
  debuffcleanse: { id: 'debuffcleanse', name: 'Debuff Cleanse', type: 'SPELL', cost: 1, attack: 0, hp: 0, description: 'Remove Freeze and Poison from a friendly unit. Shield it from all enemy spells until your next turn.', art: 'SpellIcon/DebuffCleanse.png', spellTarget: 'FRIENDLY_UNIT' },
  ...
  figure: { id: 'figure', name: 'Figure', type: 'SPELL', cost: 1, attack: 0, hp: 0, description: 'Copy a friendly unit into an empty lane with 0 ATK and its current HP. The decoy can attack but has no original abilities.', art: 'SpellIcon/Figure.png', spellTarget: 'FRIENDLY_UNIT' },
